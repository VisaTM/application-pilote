...
import './ExtractionWorkflowLauncher.scss';

export class ExtractionWorkflowLauncher extends Component {

  componentDidMount() {
    this.props.requestWorkflowsList("extraction");
  }
  ...
  render() {
    ...
    return (
      <main className="galaxy">
        ...
        <GalaxyWorkflowParameters folderName="corpus"/>
        <br />
...
ExtractionWorkflowLauncher.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(ExtractionWorkflowLauncher);
